...
public class CustomerDirectory {
    ...
    // public CustomerProfile newCustomerProfile(Person p, int age, String gender, String country, String job, int income ) {

    //     CustomerProfile sp = new CustomerProfile(p, age, country,job,income );
    //     customerlist.add(sp);
    //     return sp;
    // }
